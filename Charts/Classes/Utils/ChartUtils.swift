...
internal class ChartUtils
{
    ...
    internal class func drawMultilineText(context context: CGContext, text: String, var knownTextSize: CGSize, point: CGPoint, align: NSTextAlignment, attributes: [String : AnyObject]?, constrainedToSize: CGSize)
    {
