...
chartView.borderColor = Color.black
...
legend.font = Font(name: "HelveticaNeue-Light", size: CGFloat(12.0))!
legend.textColor = Color.label
legend.form = .square
