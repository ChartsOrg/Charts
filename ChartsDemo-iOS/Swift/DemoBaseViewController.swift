...
//        chartView.legend = l
    ...
    func chartValueSelected(_: ChartViewBase, entry _: ChartDataEntry, highlight _: Highlight) {
    ...
    func chartView(_: ChartViewBase, animatorDidStop _: Animator) {}
}
