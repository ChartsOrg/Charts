...
class DemoListViewController: UIViewController {
    ...
    private var itemDefs = [ItemDef(title: "Custom Line Chart",
                                    subtitle: "A custom demonstration of the linechart.",
                                    class: CustomLineChartViewController.self),
                            ItemDef(title: "Custom Bar Chart",
                                    subtitle: "A custom demonstration of the bar chart.",
                                    class: CustomBarChartViewController.self),
