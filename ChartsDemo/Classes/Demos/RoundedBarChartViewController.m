//
//  RoundedBarChartViewController.m
//  ChartsDemo
//
...
@interface RoundedBarChartViewController () <ChartViewDelegate>
...
@implementation RoundedBarChartViewController

- (void)viewDidLoad
{
    [super viewDidLoad];
    
    self.title = @"Rounded Corners Bar Chart";
