...
open class BlockChartRenderer: BarLineScatterCandleBubbleRenderer
{
    ...
    private func prepareBuffer(dataSet: IBarChartDataSet, index: Int)
    {
        ...
        {
            guard let e = dataSet.entryForIndex(i) as? BlockChartDataEntry else { continue }
            ...
            if !containsStacks || vals == nil
            {
                ...
                if let offsetView = dataProvider as? BlockChartView
                {
        ...
        if isDrawingValuesAllowed(dataProvider: dataProvider)
        {
            ...
            for dataSetIndex in 0 ..< barData.dataSetCount
            {
                ...
                if !dataSet.isStacked
                {
                    ...
                    {
                        guard let e = dataSet.entryForIndex(j) as? BlockChartDataEntry else { continue }
                ...
                else
                {
                    ...
                    {
                        guard let e = dataSet.entryForIndex(index) as? BlockChartDataEntry else { continue }
    ...
    open override func drawHighlighted(context: CGContext, indices: [Highlight])
    {
        ...
        for high in indices
        {
            ...
            if let e = set.entryForXValue(high.x, closestToY: high.y) as? BlockChartDataEntry
            {
    ...
    {
        guard let chart = dataProvider as? BlockChartView else { return [] }
                                          ...
                                          modifier: (NSUIAccessibilityElement) -> ()) -> NSUIAccessibilityElement
    {
        ...
        guard let e = dataSet.entryForIndex(idx/stackSize) as? BlockChartDataEntry else { return element }
