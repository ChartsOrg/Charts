...
extension CGContext {
    ...
    func drawMultilineText(_ text: String, at point: CGPoint, constrainedTo _: CGSize, anchor: CGPoint, knownTextSize: CGSize, angleRadians: CGFloat, attributes: [NSAttributedString.Key: Any]?)
    {
