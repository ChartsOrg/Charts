...
{
    @objc public static var liberty: [NSUIColor] {[
    ...
    @objc public static var joyful: [NSUIColor] {[
    ...
    @objc public static var pastel: [NSUIColor] {[
    ...
    @objc public static var colorful: [NSUIColor] {[
    ...
    @objc public static var vordiplom: [NSUIColor] {[
    ...
    @objc public static var material: [NSUIColor] {[
    ...
    @objc public static func colorFromString(_ colorString: String) -> NSUIColor
    {
