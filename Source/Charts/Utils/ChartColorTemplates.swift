...
{
    @objc open class func liberty () -> [Color]
    {
        return [
    ...
    @objc open class func joyful () -> [Color]
    {
        return [
    ...
    @objc open class func pastel () -> [Color]
    {
        return [
    ...
    @objc open class func colorful () -> [Color]
    {
        return [
    ...
    @objc open class func vordiplom () -> [Color]
    {
        return [
    ...
    @objc open class func material () -> [Color]
    {
        return [
    ...
    @objc open class func colorFromString(_ colorString: String) -> Color
    {
