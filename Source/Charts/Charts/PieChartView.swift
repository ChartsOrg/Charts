...
open class PieChartView: PieRadarChartViewBase
{
    ...
    open override func accessibilityElementCount() -> Int {
        return (self.renderer as? PieChartRenderer)?.accessiblePieChartElements.count ?? 0
    }

    open override func accessibilityElement(at index: Int) -> Any? {
        return (self.renderer as? PieChartRenderer)?.accessiblePieChartElements[index]
    }

    open override func index(ofAccessibilityElement element: Any) -> Int {
        guard let axElement: UIAccessibilityElement = element as? UIAccessibilityElement else { return -1 }
        return (self.renderer as? PieChartRenderer)?.accessiblePieChartElements.index(of: axElement) ?? -1
    }
