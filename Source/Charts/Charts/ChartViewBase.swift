...
public protocol ChartViewDelegate
{
    ...
    // Called when a dragging pan gesture has completed
    @objc optional func chart(_ chartView: ChartViewBase, didCompletePanGesture panGestureRecognizer: NSUIPanGestureRecognizer)
}
