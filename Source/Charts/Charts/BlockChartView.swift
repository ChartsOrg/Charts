...
open class BlockChartView: BarLineChartViewBase, BlockChartDataProvider
{
    ...
    {
        guard let data = self.data as? BlockChartData
            else { return }
    ...
    @objc open func getBarBounds(entry e: BlockChartDataEntry) -> CGRect
    {
        guard let
            data = _data as? BlockChartData,
    ...
    open var barData: BlockChartData? { return _data as? BlockChartData }
