...
open class AxisBase: ComponentBase
{
    ...
    open func getLongestLabel(attributes: [String: NSObject]?) -> NSAttributedString
    {
    ...
    open func getFormattedLabel(_ index: Int, attributes: [String:Any]?) -> NSAttributedString
    {
