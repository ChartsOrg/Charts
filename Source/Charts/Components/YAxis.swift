...
open class YAxis: AxisBase
{
    ...
    @objc public var needsOffset: Bool {
        return isEnabled
            && isDrawLabelsEnabled
    ...
    open override func calculate(min dataMin: Double, max dataMax: Double)
    {
        ...
        var min = isUsingCustomAxisMin ? _axisMinimum : dataMin
        var max = isUsingCustomAxisMax ? _axisMaximum : dataMax
    ...
    private var _isDrawTopYLabelEntryEnabled = true
}
