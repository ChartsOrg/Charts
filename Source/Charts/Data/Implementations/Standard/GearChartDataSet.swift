...
open class GearChartDataSet: ChartDataSet, IGearChartDataSet
{
    ...
    open var bgGearColor: UIColor? = UIColor.lightGray
    
    /// the color of the gear
    open var gearColor: UIColor? = UIColor.red
    
    /// the gear line width
    open var gearLineWidth: CGFloat = 20.0
