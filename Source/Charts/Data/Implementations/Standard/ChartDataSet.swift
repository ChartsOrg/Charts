...
open class ChartDataSet: ChartBaseDataSet
{
    ...
    internal lazy var _values: [ChartDataEntry] = []
    ...
    open override var entryCount: Int { return _values.count }
    ...
    {
        guard let i = _values.index(of: entry) else { return false }
        _values.remove(at: i)
        calcMinMax()
