Pod::Spec.new do |s|
  ...
  s.subspec "Core" do |ss|
    ss.source_files  = "Source/Charts/**/*.{swift,h}", "Source/Supporting Files/DGCharts.h"
    ss.public_header_files = "Source/Supporting Files/DGCharts.h", "Source/Charts/Utils/NSRectCorner.h"
  end
end
